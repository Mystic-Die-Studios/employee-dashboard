...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            # Without strict mode MySQL/MariaDB silently truncates oversized
            # values instead of raising -- a 40-character GitHub login would be
            # quietly cut to 39 rather than rejected.
...
# Without this Django defaults to a 32-bit AutoField and warns on every check.
